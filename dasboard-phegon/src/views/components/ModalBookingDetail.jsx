...
const ModalBookingDetail = ({ isOpen, onClose, children }) => {
    ...
    return ReactDOM.createPortal(
        <div className="fixed top-0 bottom-0 left-0 right-0 bg-gray-900 bg-opacity-50 z-100 flex items-center justify-center">
            <div className="bg-[#FFF9E5] rounded-lg p-6 w-[80%] max-w-[840px] relative max-h-[90vh] overflow-y-auto">
                <button
                    onClick={onClose}
