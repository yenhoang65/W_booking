...
import { messageClear } from "../../store/reducer/hotelReducer";
import { getMyInfo, updateInfoVendor } from "../../store/reducer/authReducer";
...
function VendorProfile() {
    ...
    const submit_request = (e) => {
        ...
        dispatch(updateInfoVendor({ userId: userInfo.id, formData, token }));
    };
