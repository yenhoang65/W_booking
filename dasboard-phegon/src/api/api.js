...
//         return axios
//             .get(`${this.BASE_URL}/vendor/hotel/all`, {
//                 headers: {
...
//             .catch((error) => {
//                 throw error; // Ném lỗi để hàm gọi lại có thể xử lý
//             });
//         // const result = await axios.get(`${this.BASE_URL}/vendor/rooms/all`);
//         // return result.data;
//     }

//     static async addHotel(formData) {
//         const result = await axios.post(
//             `${this.BASE_URL}/vendor/hotel/add`,
//             formData,
//             {
//                 headers: {
//                     ...this.getHeader(),
...
//         const result = await axios.post(
//             `${this.BASE_URL}/vendor/rooms/add`,
//             formData,
//             {
//                 headers: {
//                     ...this.getHeader(),
...
//         const response = await axios.get(`${this.BASE_URL}/vendor/rooms/types`);
//         return response.data;
//     }
//     /* This  gets all rooms from the database */
...
//         return axios
//             .get(`${this.BASE_URL}/vendor/rooms/all`, {
//                 headers: {
//                     Authorization: `Bearer ${token}`, // Thêm token vào header
//                 },
//             })
...
//         const result = await axios.get(
//             `${this.BASE_URL}/vendor/rooms/room-by-id/${roomId}`
//         );
//         return result.data;
//     }
...
//             `${this.BASE_URL}/vendor/rooms/delete/${roomId}`,
//             {
//                 headers: this.getHeader(),
//             }
//         );
...
//             `${this.BASE_URL}/vendor/rooms/update/${roomId}`,
//             formData,
//             {
//                 headers: {
//                     ...this.getHeader(),
